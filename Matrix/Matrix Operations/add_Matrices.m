% The following function can be used to add matrices.
...
% The sum of matrices is calculated face to face: 

%                 if [a , b]     [e , f]     [a+e , b+f]
%                    [c , d]  +  [g , h]  =  [c+g , d+h]


function result = addMatrices(matrix1, matrix2)
    ...
    if (rows1 == rows2) && (columns1 == columns2)
        ...
        disp('( ! Cannot add the matrices. They have different dimensions. ! )');
    end
end
